...
const HomePage = () => {
  return (
    <main className="flex min-h-[92svh] flex-col items-center justify-center">
      ...
      <div className="inset-0 flex min-h-[220px] w-full max-w-sm select-none flex-wrap content-center items-center justify-center gap-x-1 gap-y-0 text-balance px-4 align-middle capitalize sm:min-h-[300px] sm:max-w-md sm:px-0">
        <RandomWords />
      </div>
    </main>
  );
